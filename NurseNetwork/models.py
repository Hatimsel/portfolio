#!/usr/bin/python3
"""
Our models and database tables
"""
...
class User(BaseModel, db.Model, UserMixin):
    """
    User class represents both nurses and patients
    """
    ...
    def get_reset_token(self, expires_sec=1800):
        """
        A helper function to reset the password
        """
    ...
    def verify_reset_token(token):
        """
        A static method to verify the token generated by the first function
        """
...
class Infos(BaseModel, db.Model):
    """
    Infos class to get more infos about a user
    """
